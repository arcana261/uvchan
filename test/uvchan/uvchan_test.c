...
#define MAKE_ACTION_PUSH(value) make_action(ACTION_TYPE_PUSH, (value), 1, 0)
#define MAKE_ACTION_FAILING_PUSH(value) \
  make_action(ACTION_TYPE_PUSH, (value), 0, 0)
#define MAKE_ACTION_POP(value) make_action(ACTION_TYPE_POP, 0, 1, (value))
#define MAKE_ACTION_FAILING_POP() make_action(ACTION_TYPE_POP, 0, 0, 0)
